    const dadosRevisao = {
        V350: {
            ...
            tmo: { 1000: 0.0, 3000: 0.5, 6000: 0.8, 9000: 0.5, 12000: 1.8, 15000: 0.5, 18000: 1.5 }
        },
        T350: {
            1000: [
                { codigo: 'MT114', nome: 'Óleo do Motor', qtd: 2, valor: 70.00 },
        ...
        S350: {
            ...
            tmo: { 1000: 0.0, 3000: 0.5, 6000: 0.8, 9000: 0.5, 12000: 2.0, 15000: 0.5, 18000: 1.5 }
        },
        R350: {
            1000: [
                { codigo: 'MT114', nome: 'Óleo do Motor', qtd: 2, valor: 70.00 },
        ...
        E350: {
            ...
            tmo: { 1000: 0.0, 4000: 1.0, 8000: 0.8, 12000: 0.5, 16000: 1.0, 20000: 0.5, 24000: 2.0 }
        }}
/* ===============================
...
const KM_PADRAO = [1000, 3000, 6000, 9000, 12000, 18000, ];
...
function calcular() {
    ...
    if (!veiculo || !km) {
        ...
        subTMOEl.textContent = '0,0 h × R$ 350,00/h';
    ...
    /* TOTAIS */
    const totalPecas = revisao.reduce(
        (sum, p) => sum + (p.qtd * p.valor), 0
    );
    ...
    subPecasEl.textContent =
        revisao.length
            ? `${revisao.length} item(ns) na revisão`
            : 'Sem itens selecionados';

    subTMOEl.textContent =
        `${tmoHoras.toFixed(1).replace('.', ',')} h × R$ 350,00/h`;
